...
const GOV_BUILDING = [
  ...
  { emoji:"🌾", name:"PM PRANAM Scheme",     nameHi:"PM PRANAM योजना",    desc:"Incentives for states to reduce chemical fertilizer use — sustainable farming for the future.",        descHi:"राज्यों को रासायनिक उर्वरक उपयोग घटाने के लिए प्रोत्साहन — टिकाऊ खेती।",                   url:"https://www.india.gov.in" },
